...
then
    ...
    echo -e "Nothing to do MYSQL is... $Y already installed... $N" | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "Nothing to do Python3 is... $Y already installed... $N" | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "Nothing to do nginx is... $Y already installed... $N" | tee -a $LOG_FILE
fi